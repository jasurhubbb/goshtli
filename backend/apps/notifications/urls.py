...
from .views import (NotificationListView, NotificationMarkAllReadView,
                    NotificationMarkReadView, NotificationUnreadCountView, RegisterDeviceView)
...
urlpatterns = [
    ...
    path("register-device/", RegisterDeviceView.as_view(), name="notification-register-device"),  # POST FCM token
]
