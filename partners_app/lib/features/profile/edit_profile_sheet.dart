...
/// Edit profile sheet — name + phone-call availability only. animals_supported moved out into its
/// own dedicated Profil row + sheet (see animals_supported_sheet.dart) because suppliers were
/// missing the chips when they were tucked in here.
///
    ...
    try {
      ...
      if (auth.user.isQassob) {
        await api.dio.patch('/qassobs/me/', data: {
          'full_name': fullName, 'phone_visible': _phoneVisible,
        });
