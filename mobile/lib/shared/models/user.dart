// User — mirrors backend's accounts.User. The consumer app admits buyers only, but legacy role values remain
// decodable so an old supplier/admin token can be rejected cleanly instead of failing JSON parsing.
...
class User {
  ...
  final String? dateOfBirth; // ISO-8601 YYYY-MM-DD; parsed at the form layer
  ...
  // Convenience getters used by session guards.
