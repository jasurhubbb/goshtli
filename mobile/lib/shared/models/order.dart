...
enum OrderStatus {
  ...
  @JsonValue('DELIVERED_PENDING_CONFIRMATION')
...
/// CONFIRMED and payment FAILED (insufficient funds) at the same time.
...
class Order {
  ...
  // v3.7 display-friendly buyer identity fields.
  @JsonKey(name: 'buyer_name', defaultValue: '')
  final String buyerName;
  @JsonKey(name: 'buyer_phone', defaultValue: '')
  ...
  @JsonKey(name: 'listing_name_uz', defaultValue: '')
  final String listingNameUz;
  @JsonKey(name: 'listing_name_ru', defaultValue: '')
  final String listingNameRu;
  @JsonKey(name: 'listing_category_slug', defaultValue: '')
  final String listingCategorySlug;
  @JsonKey(name: 'listing_market_slug', defaultValue: '')
  final String listingMarketSlug;
  @JsonKey(
    name: 'listing_price_per_kg',
    fromJson: _decimalFromString,
    toJson: _decimalToString,
  )
  final double listingPricePerKg;
  @JsonKey(
    name: 'quantity_kg',
    fromJson: _decimalFromString,
    toJson: _decimalToString,
  ...
  @JsonKey(name: 'payment_status', defaultValue: OrderPaymentStatus.unpaid)
  ...
  @JsonKey(name: 'delivery_proof_url', defaultValue: '')
  final String deliveryProofUrl;
  @JsonKey(name: 'courier_name', defaultValue: '')
  final String courierName;
  @JsonKey(name: 'courier_phone', defaultValue: '')
  ...
  const Order({
    ...
    this.listingNameUz = '',
    this.listingNameRu = '',
    this.listingCategorySlug = '',
    this.listingMarketSlug = '',
    required this.listingPricePerKg,
  ...
  String get listingTitle =>
      listingNameUz.isNotEmpty ? listingNameUz : listingNameRu;
}
