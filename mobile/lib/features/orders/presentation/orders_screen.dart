...
class OrdersScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // The consumer app has one role: buyer. Platform operators manage fulfilment in partners_app,
    // so this screen never switches to the legacy supplier inbox.
              ...
              data: (page) => page.results.isEmpty
                  ...
                  : SliverPadding(
                      ...
                      sliver: SliverList.separated(
                        ...
                        itemBuilder: (_, i) =>
                            _OrderCard(order: page.results[i]),
                      ),
                    ),
      ...
      child: SizedBox(
        ...
        child: ListView(
          ...
          children: [
            ...
            for (final s in model.OrderStatus.values)
              Padding(
                padding: const EdgeInsets.only(right: 6),
                child: ChoiceChip(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${order.quantityKg.toStringAsFixed(2)}kg  ·  ${order.totalPrice.toStringAsFixed(2)}',
                      style: tt.bodySmall,
                    ),
