...
Future<void> showReviewSubmitSheet(
  ...
  await showModalBottomSheet(
    ...
    builder: (sctx) => _ReviewForm(orderId: orderId),
  );
}

class _ReviewForm extends ConsumerStatefulWidget {
  final int orderId;
  const _ReviewForm({required this.orderId});
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            controller: _comment,
            maxLines: 3,
            decoration: InputDecoration(labelText: t.reviewCommentOptional),
          ),
          if (_error != null)
            Padding(
