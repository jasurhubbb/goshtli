// Register screen — buyer-only signup. Platform catalog management lives in partners_app.
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) =>
                      (v == null || !v.contains('@')) ? t.validateEmail : null,
                ),
                const SizedBox(height: 12),
                TextFormField(
                  controller: _phone,
                ...
                TextFormField(
                  ...
                  validator: (v) =>
                      (v == null || v.length < 8) ? t.validateMin8 : null,
                ),
                const SizedBox(height: 12),
                TextFormField(
                  controller: _confirm,
                  ...
                  validator: (v) =>
                      v != _password.text ? t.validatePasswordMatch : null,
                ),
                // There is no role picker: every consumer-app account is a buyer.
                if (error != null)
                  Padding(
